...
CREATE TABLE Cards01 (
 ...
 , card_id      binary(16)   NOT NULL                                                    COMMENT '{"name":"単語ID","note":""}'
 , card_name    varchar(256)  NOT NULL                                                    COMMENT '{"name":"単語名","note":""}'
 , large_category_id          binary(16)   NOT NULL                                          COMMENT '{"name":"大分類ID","note":"OS識別用(1:iOS、2:Android、etc)"}'
 , small_category_id    binary(16)  NOT NULL                                                    COMMENT '{"name":"小分類ID","note":""}'
 , primal_note_id    binary(16)  DEFAULT NULL                                                    COMMENT '{"name":"優先ノートID","note":"優先表示するノートのノートID"}'
